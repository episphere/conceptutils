...
fun.tabulate=function(){
    ...
    <table style="table-layout:fixed ; width:100% ">
        <tr><td id="head1" style="vertical-align:top ; overflow:auto ;overflow-y:scroll" width="50%" height="100%">[129084652] <input size=40 onkeyup="search(this)"></td><td style="vertical-align:top ; overflow:auto" id="head2" width="50%" height="100%"><a href="https://www.youtube.com/watch?v=jWH_o8yNBZk" target="_blank" style="color:red">YouTube</a> (2 mins)</td></tr>
        <tr><td id="body1" style="vertical-align:top ; overflow:auto ;overflow-y:scroll" width="50%" height="100%">...</td><td style="vertical-align:top ; overflow:auto ; overflow-y:scroll" id="body2" width="50%" height="100%">...</td></tr>
    </table>
    `
    tabulateFun();
};
